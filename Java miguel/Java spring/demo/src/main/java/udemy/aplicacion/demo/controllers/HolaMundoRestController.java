...
public class HolaMundoRestController {
    ...
    public String parametros1(@RequestParam String parametro){
        return "Recibiendo parametros con valor " + parametro; 
    };

    @GetMapping("/parametros/{parametro2}")
    public String parametros2(@PathVariable String parametro2) {
        return "Recibiendo path variable con valor " + parametro2; 
    }
    
    @PostMapping("/parametros")
    public String postMethodName(@RequestBody Persona persona) {
        
        return "Recibiendo a la persona con nombre " + persona.getNombre();
    }
